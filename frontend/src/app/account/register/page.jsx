      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            />
            {errors.name && <div className="text-xs text-red-500 px-2">{errors.name}</div>}
          </div>
          <div className="mb-4">
            ...
            />
            {errors.email && <div className="text-xs text-red-500 px-2">{errors.email}</div>}
          </div>
          <div className="mb-4">
            ...
            />
            {errors.password && <div className="text-xs text-red-500 px-2">{errors.password}</div>}
          </div>
          <div className="mb-4">
            ...
            />
            {errors.password_confirmation && <div className="text-xs text-red-500 px-2">{errors.password_confirmation}</div>}
          </div>
          <button
            disabled={loading}
            type="submit"
