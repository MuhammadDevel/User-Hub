            ...
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        />
                        {errors.email && <div className="text-red-500 text-xs px-2">{errors.email}</div>}
                    </div>
                    ...
                    <p className="text-sm text-gray-600 p-1">
                        <Link href="/account/reset-password-link"
                            className="text-indigo-500 hover:text-indigo-600 transition duration-300 ease-in-out">Forgot Password?</Link></p>
                    <button
                        type="submit"
                ...
                <p className="p-1 text-sm text-gray-600">Don't have an account? <Link href="/account/register" className="text-indigo-500 hover:text-indigo-600 transition duration-300 ease-in-out">Create an account</Link></p>
                ...
                {serverErrorMessage && <div className="text-red-500 text-sm px-2 text-center">{serverErrorMessage}</div>}

                {serverSuccessMessage && <div className="text-green-500 text-sm px-2 text-center">{serverSuccessMessage}</div>}
            </div>
        </div>
    )
}
