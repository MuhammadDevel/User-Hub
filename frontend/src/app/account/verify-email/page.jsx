        ...
        <div className="flex items-center justify-center h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
                ...
                <p className="text-gray-500 text-sm text-center mb-4">
                    Please enter the one-time password (OTP) sent to your registered email address.OTP is valid for 15 minutes.
                </p>
                {loading && <div className="text-sm text-red-500 px-2 font-semibold text-center">Verifying your email please wait...</div>}
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        />
                        {errors.email && <div className="text-xs text-red-500 pc-2">{errors.email}</div>}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.otp && <div className="text-xs text-red-500 pc-2">{errors.otp}</div>}
                    </div>
                    <button
                        type="submit"
